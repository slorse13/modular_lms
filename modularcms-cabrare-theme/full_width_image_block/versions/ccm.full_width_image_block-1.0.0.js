 ...
 * @changes
 * - added option to enable/disable background image
...
( () => {
    ...
    const component = {
        ...
        config: {
            ...
            "html": [ "ccm.load", "https://slorse13.github.io/modular_lms/modularcms-cabrare-theme/full_width_image_block/resources/html/template.html" ],
            "css": ["ccm.load",
                "https://slorse13.github.io/modular_lms/modularcms-cabrare-theme/cabrare_theme/resources/css/global.css",
                "https://slorse13.github.io/modular_lms/modularcms-cabrare-theme/full_width_image_block/resources/css/style.css"
            ],
        ...
        Instance: function () {
            ...
            this.setStyle = () => {
                // check if background-image should be displayed - standard is false
                (this.bgimage) ? this.element.querySelector('#image').src = this.imageSrc :  this.element.querySelector('#image').style.display = "none";

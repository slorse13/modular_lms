 ...
 * @changes
 * - check for userrole admin else redirect to font-page
 * - add backend title
 * - add link to the front-end
...
( () => {
  ...
  const component = {
    ...
    config: {
      "css": [ "ccm.load",
        "https://slorse13.github.io/modular_lms/modularcms-components/cms/resources/css/colors.css",
        "https://slorse13.github.io/modular_lms/modularcms-components/cms/resources/css/style.css",
        "https://slorse13.github.io/modular_lms/modularcms-components/cms/resources/css/global.css"
      ],
      "helper": [ "ccm.load", "https://ccmjs.github.io/akless-components/modules/versions/helper-5.1.0.mjs" ],
      "html": [ "ccm.load", "https://slorse13.github.io/modular_lms/modularcms-components/cms/resources/html/cms.html" ],
      // "logo": "https://slorse13.github.io/modular_lms/modularcms-components/cms/resources/img/logo.svg",
      ...
      "menu": [
        {"title": "Pages / Chapters", "route": "/pages"},
        {"title": "Users", "route": "/users", "role": "admin"},
        {"title": "Theme definitions", "route": "/theme-definitions", "role": "admin"}
      ],
      "page_manager": [ "ccm.instance", "https://slorse13.github.io/modular_lms/modularcms-components/page_manager/versions/ccm.page_manager-1.0.0.js" ],
      "cabrare_theme": [ "ccm.instance", "https://slorse13.github.io/modular_lms/modularcms-cabrare-theme/cabrare_theme/versions/ccm.cabrare_theme-1.0.0.js" ],
      "website_manager": [ "ccm.instance", "https://slorse13.github.io/modular_lms/modularcms-components/website_manager/versions/ccm.website_manager-1.0.0.js" ],
      "user_manager": [ "ccm.instance", "https://slorse13.github.io/modular_lms/modularcms-components/user_manager/versions/ccm.user_manager-1.0.0.js" ],
      "theme_definition_manager": [ "ccm.instance", "https://slorse13.github.io/modular_lms/modularcms-components/theme_definition_manager/versions/ccm.theme_definition_manager-1.0.0.js" ],
      "profile_editor": [ "ccm.instance", "https://slorse13.github.io/modular_lms/modularcms-components/profile_editor/versions/ccm.profile_editor-1.0.0.js" ],
    ...
    Instance: function () {
      ...
      this.start = async () => {
        ...
        $.setContent(this.element, $.html(this.html.main, { title: this.title}));
        ...
        await this.routing.registerRoutingCallback(async (detail) => {
          ...
          if (loggedIn) {
            ...
            if(await this.data_controller.getUserWebsiteRole( this.user.getUsername(), websiteKey   ) == "admin"){

              // Message if user uses FireFox - but with the option to go on
                ...
                // set Backend title
                const pagenameWrapper = this.element.querySelector('#page_name-wrapper');  
                pagenameWrapper.innerHTML = "Lecture setup";

                // set front-end link in backend
                const backend = this.element.querySelector('#backend_link'); 
                  ...
                  // redirect to startpage if not admin
                  window.location.href =  "/";
                }
          }

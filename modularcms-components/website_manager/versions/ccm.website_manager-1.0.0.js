...
( () => {
    ...
    const component = {
        ...
        config: {
            "html": [ "ccm.load", "https://slorse13.github.io/modular_lms/modularcms-components/website_manager/resources/html/website_manager.html" ],
            "css": [ "ccm.load",
                "https://slorse13.github.io/modular_lms/modularcms-components/website_manager/resources/css/style.css",
            ...
            this.openCreateWebsitePanel = async () => {
                ...
                this.element.querySelector('#website-create-form').addEventListener('submit', async (e) => {
                    ...
                    await this.data_controller.createWebsite(domain, baseUrl).then(async (websiteKey) => {
                        ...
                        // Navigate SKIP INSTALL PAGE
                        this.routing.navigateTo('/pages/' + websiteKey);

 ...
 * - add option and value for restriction
        ...
        Instance: function () {
            ...
            this.createWebsite = (domain, baseUrl) => new Promise(async (resolve, reject) => {
                ...
                if (websiteMappingBefore == null) {
                    ...
                    const themeImportObject = await this.ccm.load({url: 'https://slorse13.github.io/modular_lms/modularcms-cabrare-theme/theme.json', method: 'GET'});

 ...
 * @changes
 * - added check for block restriction
                ...
                for (let contentZoneName in contentZones) {
                    ...
                    if (contentZoneElement) {
                        ...
                        let appendElements = [];
                            ...
                            // if(await this.data_controller.getUserWebsiteRole( this.user.getUsername(), websiteKey   ) 
                        for (let contentZoneItem of contentZoneItems) {
                                ...
                                if(contentZoneItem.data.ignore != undefined){
                                        if(contentZoneItem.data.ignore.config.restrict != undefined){
                                            // console.log(contentZoneItem.data.ignore.config.restrict); 
                                            isrestricted =   (contentZoneItem.data.ignore.config.restrict);
                                        }
                                }

                                // display block if is not restricted or user is not member (admin or author)
                                if(!isrestricted || await this.data_controller.getUserWebsiteRole( this.user.getUsername(), this.parent.websiteKey ) != "member"){
            ...
            this.getCcmComponentElement = async (contentZoneName, contentZoneItem, i) => {
                ...
                element.addEventListener('dblclick', () => {
                    ...
                    let handler = () => {
                        ...
                        // console.log(config); 
                        // console.log(contentZoneItem.data.ignore.config);
            ...
            this.getContentZones = () => {
                ...
                for (let contentZoneName in _contentZoneElements) {
                    re[contentZoneName] = this.getContentZone(contentZoneName); 
                         // console.log(re[contentZoneName]);
                }
                return re;
            }
        }

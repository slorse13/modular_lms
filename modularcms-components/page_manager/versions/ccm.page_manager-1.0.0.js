 ...
 * @changes
 * - add option to restrict a special page
...
( () => {
    ...
    const component = {
        ...
        config: {
            ...
            "html": [ "ccm.load", "https://slorse13.github.io/modular_lms/modularcms-components/page_manager/resources/html/page_manager.html" ],
            "css": [ "ccm.load",
                "https://slorse13.github.io/modular_lms/modularcms-components/page_manager/resources/css/style.css",
                "https://slorse13.github.io/modular_lms/modularcms-components/cms/resources/css/global.css"
            ],
            ...
            "pageRendererUrl": "https://slorse13.github.io/modular_lms/modularcms-components/page_renderer/versions/ccm.page_renderer-1.0.0.js",
            "layout_json_builder": [ "ccm.instance", "https://ccmjs.github.io/akless-components/json_builder/versions/ccm.json_builder-2.1.0.js", [ "ccm.get", "https://slorse13.github.io/modular_lms/modularcms-components/page_manager/resources/resources.js", "json_builder" ] ],
            "theme_json_builder": [ "ccm.instance", "https://ccmjs.github.io/akless-components/json_builder/versions/ccm.json_builder-2.1.0.js", [ "ccm.get", "https://slorse13.github.io/modular_lms/modularcms-components/page_manager/resources/resources.js", "json_builder" ] ],
            "component_json_builder": [ "ccm.instance", "https://ccmjs.github.io/akless-components/json_builder/versions/ccm.json_builder-2.1.0.js", [ "ccm.get", "https://slorse13.github.io/modular_lms/modularcms-components/page_manager/resources/resources.js", "json_builder" ] ],
        ...
        Instance: function () {
            ...
            this.renderMain = async () => {
                ...
                this.element.querySelectorAll('#list .list-item-more-button').forEach(elem => {
                    ...
                    elem.addEventListener('click', async (e) => {
                        ...
                        if (!showingDelete) {
                            showingDelete = true;
                            elem.src = 'https://slorse13.github.io/modular_lms/modularcms-components/cms/resources/img/trash-icon.svg';
                            elem.style.filter = 'invert(19%) sepia(100%) saturate(2779%) hue-rotate(354deg) brightness(94%) contrast(95%)';
                            setTimeout(() => {
                                showingDelete = false;
                                elem.src = 'https://slorse13.github.io/modular_lms/modularcms-components/cms/resources/img/more-icon.svg';
            ...
            this.renderEdit = async (pageKey) => {
                ...
                if (page != null) {
                    ...
                    // add value forrestriction of a page
                    const content = $.html(this.html.editPage, {
                        ...
                        restrictPage:  page.meta.restrict,
                    ...
                    // add option to restrict a page
                    const metaRestrictionInput = this.element.querySelector('#edit-page-meta-restrict');
                    ...
                    window.pageManagerEditBlockConfigEventHandler = async (e) => {
                        ...
                        let openSubmitBuilder = async (zoneItem, updateConfig) => {
                            ...
                            // console.log(zoneItem.data.ignore.config);
                        ...
                        if (form.checkValidity() && this.theme_json_builder.isValid() && this.layout_json_builder.isValid()) {
                            ...
                            Object.assign(pageSet, page, {
                                ...
                                meta: {
                                    ...
                                    restrict: metaRestrictionInput.checked
                                },
                            ...
                            let end = () => {
                                ...
                                saveButton.querySelector('.icon').src = 'https://slorse13.github.io/modular_lms/modularcms-components/cms/resources/img/checkmark-icon.svg';
                                setTimeout(() => {
                                    saveButton.querySelector('.button-text').innerHTML = 'Save';
                                    saveButton.querySelector('.icon').src = 'https://slorse13.github.io/modular_lms/modularcms-components/cms/resources/img/save-icon.svg';
                                }, 1500);
                            };
                    ...
                    publishButton.addEventListener('click', async () => {
                        ...
                        let end = () => {
                            ...
                            publishButton.querySelector('.icon').src = 'https://slorse13.github.io/modular_lms/modularcms-components/cms/resources/img/checkmark-icon.svg';
                            setTimeout(() => {
                                publishButton.querySelector('.button-text').innerHTML = 'Publish';
                                publishButton.querySelector('.icon').src = 'https://slorse13.github.io/modular_lms/modularcms-components/cms/resources/img/megaphone-icon.svg';
                            }, 1500);
                        };
